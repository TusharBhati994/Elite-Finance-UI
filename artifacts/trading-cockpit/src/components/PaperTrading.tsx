...
const [targetPrice, setTargetPrice] = useState("");
  ...
  return (
    <div className="h-44 bg-[#080b12] border-t border-slate-800/60 flex shrink-0" data-testid="paper-trading-panel">
      ...
      {/* Order Entry */}
    <div className="w-70 p-4 border-r border-slate-800/60 flex flex-col justify-start overflow-y-auto">
  ...
  <div className="flex items-center gap-2">
    ...
    />
      ...
      <div className="w-72 p-4 border-r border-slate-800/60 flex flex-col justify-center">
